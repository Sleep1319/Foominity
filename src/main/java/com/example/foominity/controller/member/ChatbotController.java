...
import com.example.foominity.service.chatbot.ChatbotService;
...
public class ChatbotController {
    ...
    public ChatResponse chat(@RequestBody ChatRequest req) {
        ...
        if ("recommend".equals(req.getMode())) {
            ...
            aiReply = chatbotService.chat(systemPrompt, "recommend");

        } else {
            // diagnosis, translate, freechat 등 기존 모드 처리
            aiReply = chatbotService.chat(req.getMessage(), req.getMode());
        }
